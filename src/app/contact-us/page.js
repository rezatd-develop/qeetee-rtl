...
export default function ContactUs() {
    return (
        <PublicLayout>
            <TitleBanner img={bannerImage} title='Contact Us' />
                ...
                <div className="col-12 col-lg-9 col-md-10 col-sm-12 row mx-0">
                    ...
                    <div className="col-12 col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div className="d-flex justify-content-between py-4">
                            <div className="font-size-750 light-text-color">Address</div>
                            <div className="font-size-750 light-text-color">31’32 3434 32 st 7 Russia</div>
                        </div>
                    </div>
                </div>
            </div>
