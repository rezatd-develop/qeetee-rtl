    ...
    return (
        <div className="d-flex justify-content-center align-items-center flex-column">
            ...
            <div className="d-flex justify-content-center align-items-center  mt-3">
                <div className="light-text-color font-size-750 prompt-font me-2">{pageNameType === enumerations.pageNameTypes.signing ? 'dont have an account?' : 'If an already account?'}</div>
                <div onClick={() => buttonClicked(pageNameType)} className="font-size-875 pink-color prompt-font">{pageNameType === enumerations.pageNameTypes.signing ? "sign Up" : "Sign In"}</div>
            </div>
        </div>
    )
}
