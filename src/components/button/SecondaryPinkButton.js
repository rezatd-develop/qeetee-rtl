...
export default function SecondaryPinkButton({ onClick, icon, iconSize, text, buttonClassName }) {
    return (
        <div onClick={onClick} className='d-flex'>
            <button className={clsx(buttonClassName, 'd-flex align-items-center pink-background transparent-border-color py-2 px-3 white-color font-size-750 prompt-font')} type="button">
